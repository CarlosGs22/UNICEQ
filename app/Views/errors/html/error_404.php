        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="error-text">
                    ...
                    <h4>Oops! Esta página no fué encontrada!</h4>
                    <p>La página que estas buscando no existe,se haya removido o cambiado.</p>
                    <a href="<?=base_url()?>" class="btn btn-primary btn-round">Ir a la página de inicio</a>
                </div>
            </div>
        </div>
    </div>
